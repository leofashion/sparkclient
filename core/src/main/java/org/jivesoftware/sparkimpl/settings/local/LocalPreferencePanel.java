...
public class LocalPreferencePanel extends JPanel {
    ...
    private JCheckBox _autoLoginBoxOA = new JCheckBox();
	...
	_useSingleTrayClick.setSelected(preferences.isUsingSingleTrayClick());
        ...
        _autoLoginBoxOA.setSelected(preferences.isAutoLoginOA());
	...
	inputPanel.setBorder(BorderFactory.createTitledBorder(Res
        ...
        ResourceUtils.resButton(_autoLoginBoxOA, Res.getString("checkbox.auto.loginOA"));
	...
	inputPanel.add(_autoLoginBoxOA,
            new GridBagConstraints(0, 7, 2, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST,
    ...
    public void setAutoLoginOA(boolean auto) {
        _autoLoginBoxOA.setSelected(auto);
    }

    public boolean getAutoLoginOA() {
        return _autoLoginBoxOA.isSelected();
    }
