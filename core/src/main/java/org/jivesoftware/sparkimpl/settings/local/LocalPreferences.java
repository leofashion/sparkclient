...
//	}
    ...
    public boolean isAutoLoginOA() {
        return Boolean.parseBoolean(props.getProperty("autoLoginEnabledOA", "false"));
    }

    public void setAutoLoginOA(boolean autoLogin) {
        props.setProperty("autoLoginEnabledOA", Boolean.toString(autoLogin));
    }
