...
public class SparkRes {
	...
	public static final String SEND_DIR_24x24 = "SEND_DIR_24x24";
    ...
    public static final String PICK_COLOR_BTN = "PICK_COLOR_BUTTON";
    public static String FOLDER_32x32 = "FOLDER_32x32";

    public static final String TAB_CHAT_DARK = "TAB_CHAT_DARK";
    public static final String TAB_CHAT_LIGHT = "TAB_CHAT_LIGHT";
    public static final String TAB_GROUPCHAT_DARK = "TAB_GROUPCHAT_DARK";
    public static final String TAB_GROUPCHAT_LIGHT = "TAB_GROUPCHAT_LIGHT";
    public static final String TAB_MYGROUP_DARK = "TAB_MYGROUP_DARK";
    public static final String TAB_MYGROUP_LIGHT = "TAB_MYGROUP_LIGHT";
    public static final String TAB_MYGROUPS_DARK = "TAB_MYGROUPS_DARK";
    public static final String TAB_MYGROUPS_LIGHT = "TAB_MYGROUPS_LIGHT";
    public static final String TAB_ORG_DARK = "TAB_ORG_DARK";
    public static final String TAB_ORG_LIGHT = "TAB_ORG_LIGHT";


    //oa
    public static final String SIGN_GOODBYE = "SIGN_GOODBYE";
    public static final String SIGN_WORKING = "SIGN_WORKING";
    public static final String SIGN_HELLO = "SIGN_HELLO";
    public static final String LOGINOA_BUTTON = "LOGINOA_BUTTON";// 进入办公系统
    public static final String WORKDAILY_BUTTON = "WORKDAILY_BUTTON";// 我的日志
    public static final String SENDMAIL_BUTTON = "SENDMAIL_BUTTON";// 发送邮件
    public static final String MYPRO_BUTTON = "MYPRO_BUTTON";// 我的项目
    public static final String PHONE_BUTTON = "PHONE_BUTTON";// 发送手机短信
    public static final String RECENT_16x16 = "RECENT_16x16_IMAGE";// 最近联系人
    public static final String HOTKEY_PREFERENCES_IMAGE = "HOTKEY_PREFERENCES_IMAGE";// 按键设置

    public static final String BOOKLIST_BUTTON = "BOOKLIST_BUTTON";// 通讯录

    public static final String GROUP_INVITE_DARK = "GROUP_INVITE_DARK";
    public static final String GROUP_INVITE_LIGHT = "GROUP_INVITE_LIGHT";
    public static final String GROUP_DESTROY_DARK = "GROUP_DESTROY_DARK";
    public static final String GROUP_DESTROY_LIGHT = "GROUP_DESTROY_LIGHT";
    public static final String GROUP_UPLOAD_FILE_DARK = "GROUP_UPLOAD_FILE_DARK";
    public static final String GROUP_UPLOAD_FILE_LIGHT = "GROUP_UPLOAD_FILE_LIGHT";
    public static final String GROUP_SETTING_DARK = "GROUP_SETTING_DARK";
    public static final String GROUP_SETTING_LIGHT = "GROUP_SETTING_LIGHT";
    public static final String GROUP_QUIT_DARK = "GROUP_QUIT_DARK";
    public static final String GROUP_QUIT_LIGHT = "GROUP_QUIT_LIGHT";
    public static final String GROUP_ICON = "GROUP_ICON";
    public static final String GROUP_SHARE_FILE_DARK = "GROUP_SHARE_FILE_DARK";
    public static final String GROUP_SHARE_FILE_LIGHT = "GROUP_SHARE_FILE_LIGHT";
