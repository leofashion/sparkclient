...
//		final RoomInfoAgent roomInfo = RoomInfoAgent.getRoomInfo(SparkManager.getConnection(),
//				roomJID);
...
//							.getDateTimeInstance(DateFormat.FULL, DateFormat.MEDIUM).format(date);
//				}
//			}
//		}
//		return creationDate;
...
//	 */
//	public static void joinConferenceOnSeperateThread(final String roomName, String roomJID,
//			String password, final String message, final Collection<String> jids) {
...
//		try {
//			GroupChatRoom chatRoom = (GroupChatRoom) chatManager.getChatContainer()
//					.getChatRoom(roomJID);
...
//			password = passwordDialog.getPassword(Res.getString("title.password.required"),
//					Res.getString("message.groupchat.require.password"),
//					SparkRes.getImageIcon(SparkRes.LOCK_16x16), SparkManager.getFocusedComponent());
//			room.setPassword(password);
...
//					JOptionPane.showMessageDialog(SparkManager.getMainWindow(), error,
//							"Unable to join the room at this time.", JOptionPane.ERROR_MESSAGE);
...
//							"Unable to join the room.", "Error", JOptionPane.ERROR_MESSAGE);
//				}
//			}
//		};
//
...
//	}
//
//	private static void invite(MultiUserChat groupChat, GroupChatRoom room, Collection<String> jids,
//			String message) {
//		if (jids != null && message != null) {
//			for (String jid : jids) {
//				groupChat.invite(jid, message);
//				room.getTranscriptWindow().insertNotificationMessage(
//						Res.getString("message.waiting.for.user.to.join", jid),
...
//		JoinGroupDialog joinDialog = new JoinGroupDialog();
...
//	 */
//	public static void inviteUsersToRoom(String serviceName, String roomName,
//			Collection<String> jids, boolean randomName) {
...
//		}
//		GroupInvitationDialog inviteDialog = new GroupInvitationDialog(useTextField);
//		inviteDialog.inviteUsersToRoom(serviceName, rooms, roomName, jids);
//	}
//
//	public static Collection<BookmarkedConference> retrieveBookmarkedConferences()
...
//		ServiceDiscoveryManager discover = ServiceDiscoveryManager
//				.getInstanceFor(SparkManager.getConnection());
//
//		try {
...
//	 */
//	public static void createPrivateConference(String serviceName, String message, String roomName,
//			Collection<String> jids) throws XMPPException {
//		final String roomJID = StringUtils.escapeNode(roomName) + "@" + serviceName;
//		final MultiUserChat multiUserChat = new MultiUserChat(SparkManager.getConnection(),
//				roomJID);
//		final LocalPreferences pref = SettingsManager.getLocalPreferences();
//
...
//	 */
//	public static GroupChatRoom enterRoomOnSameThread(final String roomName, String roomJID,
//			String password) {
//		ChatManager chatManager = SparkManager.getChatManager();
//
//		final LocalPreferences pref = SettingsManager.getLocalPreferences();
...
//
//		if (isPasswordRequired(roomJID) && password == null) {
//			password = JOptionPane.showInputDialog(null, "Enter Room Password", "Need Password",
...
//			chatManager.getChatContainer().activateChatRoom(room);
//		} else {
//			JOptionPane.showMessageDialog(SparkManager.getMainWindow(), "Unable to join the room.",
...
//	}
//
//	public static void enterRoom(final MultiUserChat groupChat, String tabTitle,
...
//			String error = errors.get(0);
//			JOptionPane.showMessageDialog(SparkManager.getMainWindow(), error,
//					"Could Not Join Room", JOptionPane.ERROR_MESSAGE);
//		} else if (groupChat.isJoined()) {
//			ChatManager chatManager = SparkManager.getChatManager();
//			chatManager.getChatContainer().addChatRoom(room);
//			chatManager.getChatContainer().activateChatRoom(room);
//		} else {
//			JOptionPane.showMessageDialog(SparkManager.getMainWindow(), "Unable to join room.",
//					"Error", JOptionPane.ERROR_MESSAGE);
//		}
//
//	}
